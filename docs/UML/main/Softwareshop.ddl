...
CREATE TABLE SoftwareUnit (
  ...
  PRIMARY KEY (software_id)) ENGINE=InnoDB;
...
CREATE TABLE SourceCode (
  ...
  PRIMARY KEY (code_id)) ENGINE=InnoDB;
...
CREATE TABLE SoftwareCategory (
  software_id int(10) NOT NULL, 
  category_id int(10) NOT NULL) ENGINE=InnoDB;
